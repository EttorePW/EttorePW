...
<section style="max-width:900px; margin:40px auto; background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
  <h2 style="color:#111; border-bottom:2px solid #eee; padding-bottom:8px;">👋 About Me</h2>
  <p>
    Hi, I'm Ettore — a Full Stack Developer with previous experience in leadership, gastronomy, and social work.
    My professional journey has taught me to work in a structured, agile, and highly adaptive manner. I now apply this mindset to software development,
...
<section style="max-width:900px; margin:40px auto; background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
  <h2 style="color:#111; border-bottom:2px solid #eee; padding-bottom:8px;">🌐 Portfolio</h2>
  <p><a href="https://ettorepesendorfer.netlify.app/" style="color:#0055ff; font-weight:bold; text-decoration:none;">Visit my website</a></p>
</section>

<section style="max-width:900px; margin:40px auto; background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
  <h2 style="color:#111; border-bottom:2px solid #eee; padding-bottom:8px;">🛠️ Tech Stack</h2>
  <p>
...
<section style="max-width:900px; margin:40px auto; background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
  ...
  <ul style="padding-left:20px;">
    <li><strong>Coders.Bay Vienna</strong> – Full Stack Diploma Program<br>Intensive hands-on training in frontend, backend, architecture, databases, and agile development.</li>
    <li><strong>Culinary Apprenticeship</strong> – Certified Cook</li>
    <li><strong>Secondary School Graduation</strong></li>
  </ul>
</section>
...
<section style="max-width:900px; margin:40px auto; background:#fff; padding:30px; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
  ...
  <ul style="padding-left:20px;">
    <li>Leader in a Christian community (IBHV)</li>
    <li>Passionate reader</li>
    <li>Creator of apps and websites</li>
  </ul>
</section>
